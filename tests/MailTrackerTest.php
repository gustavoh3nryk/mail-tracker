...
use gustavoh3nryk\MailTracker\Events\ComplaintMessageEvent;
use gustavoh3nryk\MailTracker\Events\EmailDeliveredEvent;
use gustavoh3nryk\MailTracker\Events\EmailSentEvent;
use gustavoh3nryk\MailTracker\Events\LinkClickedEvent;
use gustavoh3nryk\MailTracker\Events\ViewEmailEvent;
use gustavoh3nryk\MailTracker\Exceptions\BadUrlLink;
use gustavoh3nryk\MailTracker\MailTracker;
...
class MailTrackerTest extends SetUpTest
{
    ...
    {
        $url = action('\gustavoh3nryk\MailTracker\SNSController@callback');
    ...
    public function it_processes_a_delivery()
    {
        ...
        $response = $this->post(action('\gustavoh3nryk\MailTracker\SNSController@callback'), [
            'message' => json_encode([
